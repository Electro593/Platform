...
#ifndef _PLATFORM_WIN32_WIN32_H
#define _PLATFORM_WIN32_WIN32_H
...
#define WIN32_FUNCS \
    ...
    IMPORT(User32,   b32,                  ClientToScreen,            win32_window Window, win32_point *Point) \
    ...
    IMPORT(Kernel32, win32_handle,         CreateMutexA,              win32_security_attributes *SecurityAttributes, b32 InitialOwner, c08 *Name) \
    ...
    IMPORT(Kernel32, b32,                  FreeEnvironmentStringsW,   u16 *Strings) \
    ...
    IMPORT(User32,   b32,                  GetCursorPos,              win32_point *Point) \
    IMPORT(User32,   win32_device_context, GetDC,                     win32_window Window) \
    IMPORT(Kernel32, c16*,                 GetEnvironmentStringsW,    void) \
    ...
    IMPORT(User32,   b32,                  ScreenToClient,            win32_window Window, win32_point *Point) \
    ...
    IMPORT(Kernel32, void,                 SetLastError,              u32 ErrorCode) \
...
#endif	// !defined(_PLATFORM_WIN32_WIN32_H)
